...
<div class="flex h-screen w-full">
    ...
    <div class="w-full flex flex-col items-center justify-center">
            ...
            <div class="flex items-center gap-4 w-full my-5">
                ...
                <p class="w-full text-nowrap text-sm text-gray-500/90">inicia sesión con su usuario</p>
                <div class="w-full h-px bg-gray-300/90"></div>
            </div>
            ...
            <input type="text" placeholder="Usuario" class="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required>   
             </div>
            ...
            <div class="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                ...
                <input type="password" placeholder="Contraseña" class="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required>
            </div>
