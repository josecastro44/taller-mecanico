...
@section('contenido')
    ...
    <div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('proveedores.reporte') }}" target="_blank" class="bg-white text-[#263A47] border border-[#263A47] px-4 py-2.5 rounded-lg hover:bg-[#F1F4F8] shadow-sm transition-all flex items-center gap-2 font-medium">
