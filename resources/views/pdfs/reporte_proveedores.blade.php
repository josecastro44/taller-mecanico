...
<body>
    <div class="header">
        ...
        <div class="title">DIRECTORIO DE PROVEEDORES</div>
        <div style="font-size: 10px; color: #728495; margin-top: 5px;">Empresas y Distribuidores Asociados</div>
    </div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="text-left" style="font-weight: bold;">{{ $p->nombre }}</td>
                <td>{{ $p->rif ?? 'N/A' }}</td>
